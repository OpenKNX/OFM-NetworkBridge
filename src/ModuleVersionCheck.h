...
#if defined(NTB_ModuleVersion) && defined(MODULE_NetworkBridge_ETS)

    #define ModuleVersion_ModuleName "NetworkBridge"
    #define ModuleVersion_knxprod_h NTB_ModuleVersion
    #define ModuleVersion_version_h MODULE_NetworkBridge_ETS
