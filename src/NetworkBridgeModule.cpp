...
#include "NetworkBridge/MqttInFunction.h"
#include "NetworkBridge/MqttOutFunction.h"
#include "knxprod.h"
...
OpenKNX::Channel* NetworkBridgeModule::createChannel(uint8_t _channelIndex /* this parameter is used in macros, do not rename */)
{
    ...
    switch (ParamNTB_CHChannelType)
    {
        ...
        case 5:
            return new MqttInFunction(_channelIndex);
        case 6:
            return new MqttOutFunction(_channelIndex);
        default:
